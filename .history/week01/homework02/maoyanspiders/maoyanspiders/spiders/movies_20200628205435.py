...
class MoviesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(0,10):
            link = selecwwtor.xpath('//*[@id="app"]/div/div/div[1]/dl/dd[1]/div/div/div[1]/p[1]/a').get('href')
            name = selector.xpath('//*[@id="app"]/div/div/div[1]/dl/dd[1]/div/div/div[1]/p[1]/a').get('title')
            time = selector.xpath('//*[@id="app"]/div/div/div[1]/dl/dd[1]/div/div/div[1]/p[3]').text
