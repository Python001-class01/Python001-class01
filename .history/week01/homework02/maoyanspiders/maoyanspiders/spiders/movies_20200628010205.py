...
class MoviesSpider(scrapy.Spider):
    ...
    header = {
            ...
            'Cookie' : '__mta=251934006.1593072991075.1593276934234.1593276936746.34; uuid_n_v=v1; uuid=2395D3F0B6BC11EA9F28E30FF5FFF73C9A16AE2FA53A448DA75AEAA9D715CB59; _csrf=8557626db9b655cf9050ae7e5b2aab69278c8061c21eca95e1c3cf2130b0b64c; _lxsdk_cuid=172ea8cb247c8-0a73066b1c0a8b-4353760-100200-172ea8cb248c8; _lxsdk=2395D3F0B6BC11EA9F28E30FF5FFF73C9A16AE2FA53A448DA75AEAA9D715CB59; mojo-uuid=c457eacb7c1eb59d3d2f6c1f8d75b9c9; Hm_lvt_703e94591e87be68cc8da0da7cbd0be2=1593072989,1593073002; _lx_utm=utm_source%3Dgoogle%26utm_medium%3Dorganic; __mta=251934006.1593072991075.1593140975947.1593145813576.21; mojo-session-id={"id":"85b1b4877c2cd7b8fe7c164ecc89e4a2","time":1593275231612}; mojo-trace-id=7; Hm_lpvt_703e94591e87be68cc8da0da7cbd0be2=1593276937; _lxsdk_s=172f69a8902-be6-5a0-3e1%7C%7C14',
    ...
    def parse(self, response):
        ...
        for i in soup.find_all('div',attrs={'class' : 'movie-item-info'}):
            ...
            print(link)
            yield scrapy.Request(url=link, headers = self.h meta={'item':item},callback=self.parse1)
